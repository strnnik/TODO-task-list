...
public:
	...
	bool deleteUser(const uint32_t userID, std::string& errorMessage);
	bool findUserTaskID(const uint32_t findTaskID, std::string& errorMessage);
	bool findUserID(const uint32_t findUserID, std::string& errorMessage);
	...
	bool appointAdministrator(const uint32_t userID, std::string& errorMessage);
	bool demoteAdministrator(const uint32_t userID, std::string& errorMessage);
};
